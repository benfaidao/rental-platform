...
- Vérifiez que Railway détecte bien le port **8080** (déclaré par `EXPOSE 8080` dans `gateway/Dockerfile` et `listen 8080` dans la config nginx) comme port d'écoute du service.
