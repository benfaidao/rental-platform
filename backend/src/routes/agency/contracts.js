...
router.post('/', async (req, res) => {
  const {
    ...
    guaranteeCheckNumber, isSubRental, subrenterName, startMileage, notes, amountPaid,
...
router.put('/:contractId', async (req, res) => {
  const {
    ...
    startDate, endDate, rentalAmount, guaranteeAmount, currency, guaranteeCheck,
    guaranteeCheckNumber, isSubRental, subrenterName, status, startMileage,
  ...
  const contract = await prisma.rentalContract.update({
    ...
    data: {
      ...
      currency, guaranteeCheck, guaranteeCheckNumber, isSubRental, subrenterName, status: resolvedStatus,
