...
const ARTICLES = [
  {
    ...
    content: `Les présentes Conditions Générales d'Utilisation (ci-après « CGU ») régissent l'accès et l'utilisation de la plateforme MobilisCar (ci-après « la Plateforme »), éditée par MobilisCar. En soumettant une demande d'accès ou en utilisant la Plateforme, l'utilisateur (ci-après « l'Agence ») accepte sans réserve les présentes CGU. Ces CGU s'appliquent à toute personne physique ou morale exploitant une agence de location de véhicules et souhaitant utiliser la Plateforme à des fins professionnelles.`,
  },
  {
  ...
  },
  {
    ...
    content: `L'accès à la Plateforme est soumis à un abonnement mensuel ou annuel. Les tarifs en vigueur sont disponibles sur la page de demande d'accès de MobilisCar. MobilisCar se réserve le droit de modifier ses tarifs avec un préavis de 30 jours notifié par email. En cas de non-paiement à l'échéance, MobilisCar peut suspendre l'accès à la Plateforme après une mise en demeure restée sans réponse sous 7 jours.`,
  },
  {
  ...
  },
  {
    ...
    content: `Chacune des parties peut résilier le contrat à tout moment avec un préavis de 30 jours adressé par email à contact@mobiliscar.com. En cas de violation grave des présentes CGU, MobilisCar peut résilier immédiatement l'accès sans préavis ni indemnité. Après résiliation, l'Agence peut demander l'export de ses données dans un délai de 30 jours. Passé ce délai, les données seront supprimées définitivement.`,
  },
  {
    title: 'Article 10 — Droit applicable et juridiction',
    content: `Les présentes CGU sont régies par le droit français et marocain. En cas de litige, les parties s'engagent à rechercher une solution amiable avant tout recours judiciaire. À défaut d'accord amiable dans un délai de 30 jours, tout litige sera soumis à la compétence exclusive des tribunaux compétents. La version française des présentes CGU fait foi en cas de contradiction avec toute traduction.`,
  },
]
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-10 sm:py-14">
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          <div className="bg-blue-50 border border-blue-100 rounded-2xl p-4 sm:p-5 mb-8 text-sm text-blue-800 leading-relaxed">
            En utilisant la plateforme MobilisCar, vous acceptez sans réserve les présentes conditions. Ces CGU régissent l'utilisation de la plateforme et garantissent la protection de vos données conformément au RGPD.
          </div>
      ...
      <section className="bg-gray-50 border-t border-gray-200 py-8">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center space-y-3">
          <p className="text-sm text-gray-500">Des questions sur nos conditions ?</p>
